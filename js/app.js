...
function checkWin(){
	...
	for (var i = 0; i < pionArray.length; i++) {
		...
		if (table[0][0] == table[0][1] && table[0][0] == table[0][2]  && table[0][0] == joueurs[whichPlayer(turn)]) {
		...
		else if(table[0][2] == table[1][1] && table[0][2] == table[2][0] && table[0][2] == joueurs[whichPlayer(turn)]){
		alert("vous aver gagner");
		}	
